    ...
    <>
      <section id="hero" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative', padding: '130px 60px 90px', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', flexDirection: 'column', gap: '40px' }}>
            ...
            <div style={{ width: '100%', maxWidth: '420px' }}>
              <img
                ...
                alt="Guardian Shield — System Level Protection"
                style={{ width: '100%', borderRadius: '16px', filter: 'drop-shadow(0 0 40px rgba(200,30,30,0.5))' }}
              />
            </div>
          </div>
        </div>
      ...
      <section id="whatsinside">
        ...
        <div className="spec-grid reveal">
          <div className="spec-card">
            <div className="sc-icon"><img src="/images/icon_shield.png" alt="Guardian Shield" /></div>
          ...
          <div className="spec-card">
            <div className="sc-icon"><img src="/images/icon_brain.png" alt="AI Counselor" /></div>
            <div className="sc-label">Mental Support</div>
            <div className="sc-title">AI Counselor</div>
            <p className="sc-text">24/7 on-device AI recovery counselor. No internet required. No messages transmitted. Listens without judgment — available the moment you need it.</p>
          </div>
          <div className="spec-card">
            <div className="sc-icon"><img src="/images/icon_sos.png" alt="SOS Mode" /></div>
            <div className="sc-label">Emergency Protocol</div>
            <div className="sc-title">SOS Mode</div>
            <p className="sc-text">Instant crisis intervention with guided breathing and mental reframing. One tap — no delay, no confirmation. Designed to hold 10–20 minutes.</p>
          </div>
          <div className="spec-card">
            <div className="sc-icon"><img src="/images/icon_trophy.png" alt="Challenge Arena" /></div>
          ...
          <div className="spec-card">
            <div className="sc-icon"><img src="/images/icon_roadmap.png" alt="Journey Roadmap" /></div>
            <div className="sc-label">Progress Tracking</div>
            <div className="sc-title">Journey Roadmap</div>
            <p className="sc-text">Day-by-day biological recovery milestones. Track dopamine reset, neural pathway rebuilding, and cognitive clarity — all locally on device.</p>
          </div>
          <div className="spec-card">
            <div className="sc-icon"><img src="/images/icon_squad.png" alt="Squad Community" /></div>
            <div className="sc-label">Brotherhood</div>
            <div className="sc-title">Squad Community</div>
            <p className="sc-text">12,400+ anonymous warriors in real-time. Share victories and insights. Collective accountability — no names, no profiles, no data exposure.</p>
          </div>
          <div className="spec-card">
            <div className="sc-icon"><img src="/images/icon_lock.png" alt="Zero Transmission" /></div>
          ...
          <div className="spec-card">
            <div className="sc-icon"><img src="/images/icon_apk.png" alt="Direct APK" /></div>
            <div className="sc-label">Distribution</div>
            <div className="sc-title">Direct APK</div>
            <p className="sc-text">No Play Store. No Google account. No download history. Sideload directly — under 60 seconds, zero trace on cloud accounts.</p>
          </div>
        </div>
      </section>
      ...
      <section id="proof">
        ...
        <div className="testi-grid">
          <div className="testi reveal"><p className="testi-text">I've been in recovery for three years. Every app I used before had a backdoor I eventually found. NoRelapse was the first one where I reached for the backdoor and there was a wall. That wall held for the first 30 days. After 30 days, I didn't need it anymore.</p><div className="testi-meta"><div className="t-av-img"><img src="/images/warrior_avatars.png" alt="Warrior Avatar" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: '0% center' }} /></div><div><div className="t-name">Marcus T.</div><div className="t-det">Software Engineer, 27</div></div><div className="t-sk">247<span>Day Streak</span></div></div></div>
          <div className="testi reveal"><p className="testi-text">What sold me was knowing my data stays on my phone. I wasn't willing to let a company log my entire browsing pattern to sell me a cleaner image of myself. NoRelapse processes everything locally. Nothing leaves the device. That was the dealbreaker for every other app.</p><div className="testi-meta"><div className="t-av-img"><img src="/images/warrior_avatars.png" alt="Warrior Avatar" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: '50% center' }} /></div><div><div className="t-name">J. Reinholt</div><div className="t-det">Finance, 31</div></div><div className="testi-meta-right"><div className="t-sk">180<span>Day Streak</span></div></div></div></div>
          <div className="testi reveal"><p className="testi-text">The Vault Lock is the feature. I set a 2-hour override delay on a Sunday evening. Tuesday at 1 AM the urge hit hard. I went to disable it. 2-hour timer started. I fell asleep before it ended. Woke up and it was over. That is the only thing that has ever worked for me.</p><div className="testi-meta"><div className="t-av-img"><img src="/images/warrior_avatars.png" alt="Warrior Avatar" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: '100% center' }} /></div><div><div className="t-name">Dev K.</div><div className="t-det">Medical Student, 24</div></div><div className="t-sk">94<span>Day Streak</span></div></div></div>
        </div>
      ...
      <section id="install" style={{ background: 'var(--deep)', padding: '120px 60px' }}>
        ...
        <div className="reveal" style={{ marginTop: '100px', textAlign: 'center' }}>
          <div style={{ background: 'rgba(255,255,255,0.03)', padding: '40px', borderRadius: '4px', border: '1px solid var(--iron)', display: 'inline-block', maxWidth: '600px', position: 'relative' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '24px', marginBottom: '20px' }}>
              <img
                src="/images/security_seal.png"
                alt="Security Certified — 0/72 Detections"
                style={{ width: '120px', height: '120px', objectFit: 'contain', filter: 'drop-shadow(0 0 20px rgba(212,160,23,0.6))' }}
              />
              <div style={{ textAlign: 'left' }}>
                <h3 style={{ fontSize: '1.8rem', color: 'var(--white)', marginBottom: '6px' }}>SECURITY CERTIFIED</h3>
                <p style={{ fontSize: '1.1rem', color: 'var(--ghost)', marginBottom: '8px' }}>
                  <span style={{ color: 'var(--rh)', fontWeight: 'bold' }}>0/72 DETECTIONS:</span> No threats detected by any major security engine.
                </p>
                <div style={{ fontFamily: 'monospace', fontSize: '0.85rem', color: 'var(--dim)', wordBreak: 'break-all' }}>
      ...
      <section id="cta">
        ...
        <div className="cta-shields reveal">
          <div className="shield shield-img" style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'rgba(255,255,255,0.05)', padding: '10px 20px', borderRadius: '100px', border: '1px solid var(--iron)' }}>
            <img src="/images/badge_zero_data.png" alt="Zero Data Transmitted" style={{ width: '32px', height: '32px', objectFit: 'contain' }} />
            <span>Zero Data Transmitted</span>
          </div>
          <div className="shield shield-img" style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'rgba(255,255,255,0.05)', padding: '10px 20px', borderRadius: '100px', border: '1px solid var(--iron)' }}>
            <img src="/images/badge_no_account.png" alt="No Account Required" style={{ width: '32px', height: '32px', objectFit: 'contain' }} />
            <span>No Account Required</span>
          </div>
          <div className="shield shield-img" style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'rgba(255,255,255,0.05)', padding: '10px 20px', borderRadius: '100px', border: '1px solid var(--iron)' }}>
            <img src="/images/badge_no_playstore.png" alt="No Play Store" style={{ width: '32px', height: '32px', objectFit: 'contain' }} />
            <span>No Play Store</span>
          </div>
          <div className="shield shield-img" style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'rgba(255,255,255,0.05)', padding: '10px 20px', borderRadius: '100px', border: '1px solid var(--iron)' }}>
            <img src="/images/badge_audit.png" alt="Open to Audit" style={{ width: '32px', height: '32px', objectFit: 'contain' }} />
            <span>Open to Audit</span>
          </div>
        </div>
